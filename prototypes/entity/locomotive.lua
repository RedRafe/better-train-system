...
mk3.max_health = 2500
mk3.max_speed = settings.startup["bts-double-mk3-max-speed-setting"].value * 0.1667 * 0.1667 * 0.1667
...
mk4.max_health = 3000
mk4.max_speed = settings.startup["bts-double-mk4-max-speed-setting"].value * 0.1667 * 0.1667 * 0.1667
