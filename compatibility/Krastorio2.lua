...
insert(data.raw.locomotive['locomotive-mk2'].energy_source.fuel_categories, 'vehicle-fuel')
insert(data.raw.locomotive['locomotive-mk3'].energy_source.fuel_categories, 'vehicle-fuel')
insert(data.raw.locomotive['locomotive-mk4'].energy_source.fuel_categories, 'vehicle-fuel')
